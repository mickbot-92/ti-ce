...
const AtomDef atomsdefs[] = {
  {  1,  0,  0, REACTIVE_NONMETAL       , "Hydrogene"    , "H"   ,   0, 1.00784     , 2.2   },
  ...
  {  5, 12,  1, METALLOID               , "Bore"         , "B"   ,   6, 10.806      , 2.04  },
  {  6, 13,  1, REACTIVE_NONMETAL       , "Carbone"      , "C"   ,   6, 12.0096     , 2.55  },
  {  7, 14,  1, REACTIVE_NONMETAL       , "Azote"        , "N"   ,   7, 14.00643    , 3.04  },
  {  8, 15,  1, REACTIVE_NONMETAL       , "Oxygene"      , "O"   ,   8, 15.99903    , 3.44  },
  {  9, 16,  1, HALOGEN                 , "Fluor"        , "F"   ,  10, 18.9984032  , 3.98  },
  ...
  { 14, 13,  2, METALLOID               , "Silicium"     , "Si"  ,  14, 28.084      , 1.9   },
  { 15, 14,  2, REACTIVE_NONMETAL       , "Phosphore"    , "P"   ,  16, 30.973762   , 2.19  },
  { 16, 15,  2, REACTIVE_NONMETAL       , "Soufre"       , "S"   ,  16, 32.059      , 2.58  },
  { 17, 16,  2, HALOGEN                 , "Chlore"       , "Cl"  ,  18, 35.446      , 3.16  },
  ...
  { 35, 16,  3, HALOGEN                 , "Brome"        , "Br"  ,  44, 79.904      , 2.96  },
  ...
  { 47, 10,  4, TRANSITION_METAL        , "Argent"       , "Ag"  ,  60, 107.8682    , 1.93  },
  ...
  { 53, 16,  4, HALOGEN                 , "Iode"         , "I"   ,  74, 126.90447   , 2.66  },
  { 54, 17,  4, NOBLE_GAS               , "Xenon"        , "Xe"  ,  78, 131.293     , 2.60  },
  
  
  { 55,  0,  5, ALKALI_METAL            , "Cesium"       , "Cs"  ,  78, 132.905452  , 0.79  },
  { 56,  1,  5, ALKALI_EARTH_METAL      , "Baryum"       , "Ba"  ,  82, 137.327     , 0.89  },

  { 57,  3,  7, LANTHANIDE              , "Lanthane"     , "La"  ,  82, 138.90547   , 1.10  },
  { 58,  4,  7, LANTHANIDE              , "Cerium"       , "Ce"  ,  82, 140.116     , 1.12  },
  { 59,  5,  7, LANTHANIDE              , "Praseodymium" , "Pr"  ,  82, 140.90765   , 1.13  },
  { 60,  6,  7, LANTHANIDE              , "Neodyme"      , "Nd"  ,  82, 144.242     , 1.14  },
